  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{ trans('adminlte_lang::menu.grupos') }}</h5>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-12">
            <table id="table-grupos" class="table table-bordered table-hover" style="width:100%">
              <thead>
               <tr>
                <th>id</th>
                <th>Nombre</th>                   
